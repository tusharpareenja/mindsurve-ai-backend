"""Alembic environment — uses app settings + SQLAlchemy Base metadata."""
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        compare_type=True,
        # Separate from Unilever's alembic_version when sharing one Postgres
        version_table="alembic_version_mindsurve",
    )
